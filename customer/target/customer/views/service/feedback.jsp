...
<div class="weadmin-body">
    <div class="layui-row">
<form class="layui-form layui-col-md12 we-search" action="service/searchFeedback">
    ...
    <table class="layui-table" id="memberList">
        ...
        <c:forEach items="${list}" var="serviceManage">
            <tr>
                ...
                <td><a title="服务反馈详情" href="service/feedback/${serviceManage.id}"><i class="layui-icon">&#xe642;</i></a> </td>
            </tr>
        </c:forEach>
    </table>
    <%--分页功能实现--%>
