...
<div class="weadmin-body">
    <div class="layui-row">
<form class="layui-form layui-col-md12 we-search" action="service/searchFile">
    ...
    <table class="layui-table" id="memberList">
        ...
        <c:forEach items="${list}" var="serviceManage">
            <tr>
                ...
                <td>${serviceManage.status}</td>
                <td><a title="服务归档详情" href="service/file/${serviceManage.id}"><i class="layui-icon">&#xe642;</i></a> </td>
            </tr>
        </c:forEach>
    </table>
