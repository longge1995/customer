...
<div class="weadmin-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 we-search" action="/CustomerService/findByYear">
            ...
            <div class="layui-inline">
                <select name="year">
                    ...
                    <c:forEach items="${list1}" var="CustomerService">
                        <option>${CustomerService.time}</option>
                    </c:forEach>
                </select>
            </div>
...
<table class="layui-table" id="memberList">
    ...
    <c:forEach items="${list}" var="CustomerService">
        <tr>
            <td>${CustomerService.id}</td>
            <td>${CustomerService.serviceType}</td>
            <td>${CustomerService.sum}</td>
        </tr>
    </c:forEach>
</table>
    <%--分页功能实现--%>
