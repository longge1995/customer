...
<div class="weadmin-body">
    <div class="layui-row">
    <form class="layui-form layui-col-md12 we-search" action="/CustomerLoss/findCustomerLoss">
        ...
        <%--<input type="search" name="customername"
                                   placeholder="请输入客户名称" autocomplete="off" class="layui-input"/><br/>--%>
        <div class="layui-inline">
            客户经理
        </div>
        <div class="layui-inline">
            <input type="text" name="customermanager" placeholder="请输入客户经理" autocomplete="off" class="layui-input"/>
        </div>
        <%--<input type="search" name="customermanager"
                                   placeholder="请输入客户经理" autocomplete="off" class="layui-input"/><br/>--%>
...
<table class="layui-table" id="memberList">
    ...
    <c:forEach items="${list0}" var="CustomerLoss">
        <tr>
            <td>${CustomerLoss.id}</td>
            <td>${CustomerLoss.year}</td>
            <td>${CustomerLoss.customerName}</td>
            <td>${CustomerLoss.customerMgr}</td>
            <td>${CustomerLoss.lossReason}</td>
        </tr>
    </c:forEach>
</table>
    <%--分页功能实现--%>
