...
/*function preLink() { spanPre.innerHTML = "<a href='javascript:pre();'><i class=\"layui-icon\">&#xe65a;</i></a>"; }*/
/*function preNoLink(){ spanPre.innerHTML = "<i class=\"layui-icon\">&#xe65a;</i>"; }*/
function preLink() {
    spanPre.classList.remove("layui-bg-gray");
    spanPre.innerHTML = "<a href='javascript:pre();'><i class=\"layui-icon\">&#xe603;</i></a>";
}
function preNoLink(){
    spanPre.innerHTML = "<i class=\"layui-icon\">&#xe603;</i>";
    spanPre.classList.add("layui-bg-gray");
}

function nextLink() {
    spanNext.classList.remove("layui-bg-gray");
    spanNext.innerHTML = "<a href='javascript:next();'><i class=\"layui-icon\">&#xe602;</i></a>";
}
function nextNoLink(){
    spanNext.innerHTML = "<i class=\"layui-icon\">&#xe602;</i>";
    spanNext.classList.add("layui-bg-gray");
}

function firstLink() {
    spanFirst.classList.remove("layui-bg-gray");
    spanFirst.innerHTML = "<a href='javascript:first();'><i class=\"layui-icon\">&#xe619;</i></a>";
}
function firstNoLink(){
    spanFirst.innerHTML = "<i class=\"layui-icon\">&#xe619;</i>";
    spanFirst.classList.add("layui-bg-gray");
}

function lastLink() {
    spanLast.classList.remove("layui-bg-gray");
    spanLast.innerHTML = "<a href='javascript:last();'><i class=\"layui-icon\">&#xe61a;</i></a>";
}
function lastNoLink(){
    spanLast.innerHTML = "<i class=\"layui-icon\">&#xe61a;</i>";
    spanLast.classList.add("layui-bg-gray");
}
