...
<form action="service/saveFeedback">
    <table id="test1" class="layui-table"   lay-skin="line">
        ...
        <tr>
            ...
            <td colspan="3"><input style="width: 500px;" type="text" name="processContent" value="${serviceManage.processContent}" required/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" name="processResult" value="${serviceManage.processResult}" /></td>
            <th class="layui-bg-gray">满意度</th>
            <td>
                <select name="processSatisfaction">
