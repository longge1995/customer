...
<form action="service/saveFeedback">
    <table  id="test1" class="layui-table"   lay-skin="line">
        ...
        <tr>
            ...
            <td colspan="3"><input type="text" name="outLine" value="${serviceManage.outLine}" readonly/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3"><input type="text" name="serviceReq" value="${serviceManage.serviceReq}" readonly/></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td colspan="3"><input type="text" name="processContent" value="${serviceManage.processContent}" readonly/></td>
        </tr>
        <tr>
            <th class="layui-bg-gray">处理人</th>
            <td><input type="text" name="processName" value="${serviceManage.processName}" readonly/></td>
            <th class="layui-bg-gray">处理时间</th>
            <td><input type="text" name="processTime" value="${serviceManage.processTime}" readonly/></td>
        </tr>
        <tr>
            <th class="layui-bg-gray">处理结果</th>
            <td><input type="text" name="processResult" value="${serviceManage.processResult}" readonly /></td>
            <th class="layui-bg-gray">满意度</th>
            <td>
                <input type="text" name="processSatisfaction" value="${serviceManage.processSatisfaction}" readonly />
            </td>
        </tr>


                <input style="position: absolute;top: 16px;right: 30px;" class="layui-btn layui-bg-orange" type="button" name="Submit" value="返回" onclick="javascript:history.back()" />
