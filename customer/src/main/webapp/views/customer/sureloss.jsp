...
<table id="test1" class="layui-table"   lay-skin="line">
    <form action="/customer/updatesureloss">
        <tr>
        ...
        <tr>
            ...
            <td colspan="3">${loss.pauseWay}</td>
        </tr>
        <tr>
            <th class="layui-bg-gray">流失原因</th>
            <td colspan="3">
              <%--  <input type="text" name="lossReason" value="${loss.lossReason}">--%>
                <textarea style="width: 400px;height: 100px;" name="lossReason" value="${loss.lossReason}" required></textarea><i style="color:red;">*</i>
            </td>
        </tr>

            <%--<a href="/customer/deferloss?id=${loss.id}"><input class="layui-btn" type="button" value="暂缓流失"></a>--%>
        <input style="position: absolute;right: 30px;top: 16px;" class="layui-btn layui-bg-blue"  type="submit" value="保存">
