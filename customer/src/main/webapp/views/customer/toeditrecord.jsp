    ...
    <div class="sales_input layui-fluid">
        ...
        <blockquote class="layui-elem-quote layui-quote-nm ">
            <table id="test1" class="layui-table"  lay-skin="line">
                <form action="/customer/toupdaterecord" method="get">
                    <input type="text" value="${record.customerId}" name="customerId" style="display: none">
                    <input type="text" value="${record.id}" name="id" style="display: none">
                    <tr>
                        <th class="layui-bg-gray">时间</th>
                        <td>
                            <input type="text" value="${record.contactTime}" name="contactTime" readonly>
                            <i style="color:red;">*</i>
                            <%--<input type="date" value="${record.contactTime}" name="contactTime">--%>
                        </td>
                        <th class="layui-bg-gray">地点</th>
                        <td><input type="text" value="${record.place}" name="place" required><i style="color:red;">*</i></td>
                    </tr>
                    <tr>
                        <th class="layui-bg-gray">概要</th>
                        <td><input type="text" value="${record.outline}" name="outline" required><i style="color:red;">*</i></td>
                        <th class="layui-bg-gray">备注</th>
                        <td><input type="text" value="${record.remarks}" name="remarks"></td>
                    </tr>
                    <tr>
                        <th class="layui-bg-gray">详细信息</th>
                        <td colspan="3"><input type="text" value="${record.detailedInfo}" name="detailedInfo"></td>
                    </tr>
                  <div style="display: inline-block;position: absolute;top: 16px;right: 30px;">
                    ...
                    <%--<input type="text" value="${record.contactTime}" name="contactTime">
                    <input type="text" value="${record.place}" name="place">
                    <input type="text" value="${record.outline}" name="outline">
                    <input type="text" value="${record.remarks}" name="remarks">
                    <input type="text" value="${record.detailedInfo}" name="detailedInfo">
